...
uint8_t CPU::get_flag(PROCSTATUS P) { return (registers.P & P) != 0 ? 0x01 : 0x00; }
...
void CPU::write(uint16_t address, uint8_t value) { bus->write(address, value); }
